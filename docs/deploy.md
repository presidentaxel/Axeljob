...
`SENTRY_AUTH_TOKEN` : secret de **build** uniquement (source maps, AXE-368). **Pas** dans `.env` (`env_file` l'injecterait dans le conteneur backend). Jamais dans l'image nginx.
