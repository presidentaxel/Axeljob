 ...
 *
 * Quatre poignees : nw, ne, sw, se. Le bord oppose a la poignee reste
 * fixe pendant le drag (comportement type Canva).
 */
...
export const RESIZE_HANDLES = Object.freeze(['nw', 'ne', 'sw', 'se']);
...
/**
 * Applique un delta mm (depuis le pointer) a partir de la geometrie initiale
 * du bloc et de la poignee tiree. Retourne { x, y, w, h } clampes dans la page.
 *
