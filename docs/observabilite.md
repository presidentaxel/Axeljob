...
`.env.example`, `frontend/.env.example`, `frontend/Dockerfile` ARG et `docker-compose.yml` : [AXE-369](https://linear.app/axel-project/issue/AXE-369). DSN **vides** dans Git. `SENTRY_AUTH_TOKEN` n'est **pas** une clé de `.env`.
